...
const Index = () => {
  ...
  const [translateSettings1, setTranslateSettings1] =
  ...
  const handleTranslate = async () => {
    if (!languageSetting?.primaryLanguageCode) {
      message.error(t("Please set the primary language first."));
      return;
    }
    if (!selectedLanguageCode) {
      message.error(t("Please select a language to translate first."));
      return;
    }
