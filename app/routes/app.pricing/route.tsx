...
const Index = () => {
    ...
    const plans = [
        ...
        },
        {
            ...
            features: [
                t('{{credits}} credits/month', { credits: "5,000,000" }),
                t('Unlimited product translation'),
                t('Extra purchase characters'),
                t('Editable translation content'),
                t('Multiple AI model translation'),
        ...
        },
        {
            ...
            isRecommended: true,
            features: [
                t('{{credits}} credits/month', { credits: "10,000,000" }),
                t('Unlimited product translation'),
                t('Extra purchase characters'),
                t('Editable translation content'),
                t('Multiple AI model translation'),
