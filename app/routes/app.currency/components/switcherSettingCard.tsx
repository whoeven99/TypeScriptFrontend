      ...
      <Card>
        <Space direction="vertical" size="small" style={{ display: "flex" }}>
          <div className="card-header">
            ...
            {isVisible ? <Text> Completed</Text> : <Text> Uncompleted</Text>}
          ...
          <Text>
            2. Under the <strong>’Store defaults‘</strong> section, click Change
            currency formatting, then change with the code below:
          </Text>
          {isWithMoneyVisible && (
            <div>
      ...
      <Card>
        <Space direction="vertical" size="small" style={{ display: "flex" }}>
          <div className="card-header">
            ...
            <Text>{isEnable ? "Completed" : "Uncompleted"}</Text>
          </div>
          <Text>
            Please{" "}
