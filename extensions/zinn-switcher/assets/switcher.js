...
async function fetchCurrencies(shop) {
  ...
  class CiwiswitcherForm extends HTMLElement {
    constructor() {
      ...
      this.elements.languageSwitcher.addEventListener('change', this.updateLanguage.bind(this));
      this.elements.currencySwitcher.addEventListener('change', this.updateCurrency.bind(this));
    }
