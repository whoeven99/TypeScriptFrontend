import { hasTranslationCoreGlossaryLoader, loadTranslationCoreGlossaryRows, } from "./runtime.js";
 ...
 */
export async function loadGlossaryLines(shopName, target) {
    ...
    try {
        if (hasTranslationCoreGlossaryLoader()) {
            ...
            lines = rows
                ...
                .filter((r) => glossaryTargetMatchesLocale(r.targetText, r.sourceText, target))
...
export function __clearGlossaryCache() {
    cache.clear();
}
